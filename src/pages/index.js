        ...
        <div className="max-w-screen-md max-w-screen-lg mx-auto px-5 py-16 md:pt-28">
          <div className="flex flex-row flex-wrap">
            ...
            <div className="flex-1 ml-3 mt-3 md:mt-0">
              ...
              <p className="text-sm" >
              In 2011, she was awarded the Second Prize scholarships for excellent study from China Conservatory of Music. In 2012, she won the Third Prize in the Eighth International Piano Competition <b>"Young Virtuosos"</b> (Group IV, up to 23 years old) in Bulgaria and performed at the award concert. In 2015, she won the Second Prize, MTNA State competition in Wyoming.</p>      
            </div>
            <div className="mt-3">
